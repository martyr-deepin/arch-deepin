...
patchfile=${_pkgname}_${pkgver}-3deepin3.debian.tar.gz
source=(${pkgsite}/deepin/pool/main/p/${_pkgname}/${_pkgname}_${pkgver}.orig.tar.gz
        python27.patch
        ${pkgsite}/deepin/pool/main/p/${_pkgname}/${patchfile})
